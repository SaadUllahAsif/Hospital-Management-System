            ...
            <form id="member-registration" action="" method="post" class="form-validate form-horizontal well">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="paitentid" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">Indoor/Outdoor </label>
...
<?php
    ...
    if(isset($_POST['register']))
    {
        ...
        $query="INSERT INTO `paitent`(`paitentno`, `date`, `name`, `paitenttype`, `phone`, `address`, `email`, `password`, `hintanswer`) VALUES ('$paitentid','$date','$name','$type','$number','$address','$email','$password','$hint')";
